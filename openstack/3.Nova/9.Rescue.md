...
- Lưu ý: Trong quá trình boot thì instance disk và rescue disk có thể trùng UUID , vì thế trong 1 một số trường hợp thì instance đã vào mode rescue nhưng vẫn boot từ local disk
