...
| debug / recovery / convert format | Có metadata → nếu file qcow2 bị hỏng có thể khó recovery hơn | file raw đơn giản như bản dump ổ cứng → dễ di chuyển, convert, phục hồi |
